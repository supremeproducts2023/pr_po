		...
		<script type="text/javascript" language="javascript">
			...
			function lovProduct() {
				...
				if (returnvalue != null) {
					...
					if (values[1] != "") {
						document.getElementById("prod_no").value = values[1];
					} else {
						document.getElementById("prod_no").value = '';
					}
					if (values[2] != "") {
						document.getElementById("prod_name").value = values[2];
					} else {
						document.getElementById("prod_name").value = '';
					}
					if (values[3] != "") {
						document.getElementById("prod_unit").value = values[3];
					} else {
	...
	<body topmargin="0" leftmargin="0">
		<div align="center">
			<form name="form_prdet" action="prdet_add.php" method="post">
				...
				<input name="pr_no" type="hidden" value="<?php echo $pr_no; ?>">
									...
									<td>
										...
										<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
											<tr>
												...
												<td width="439"><input name="pr_no" type="text" class="style_readonly" value="<?php echo $pr_no; ?>" readonly=""></td>
											</tr>
										</table>
									</td>
								</tr>
									...
									<td>
										<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
											<tr>
												<th>
													<div align="right">
														<a onClick="return check_prdet(document.form_prdet);" style="cursor:hand" onMouseDown="document.images['butsave'].src=save3.src" onMouseUp="document.images['butsave'].src=save1.src" onMouseOver="document.images['butsave'].src=save2.src" onMouseOut="document.images['butsave'].src=save1.src">
															<img src="../include/button/save1.gif" name="butsave" width="106" height="24" border="0"></a>
														<a onClick="document.form_prdet.reset();" style="cursor:hand" onMousedown="document.images['butcancel'].src=cancel3.src" onMouseup="document.images['butcancel'].src=cancel1.src" onMouseOver="document.images['butcancel'].src=cancel2.src" onMouseOut="document.images['butcancel'].src=cancel1.src">
