		...
		<tr><td>
              <table width="100%"  border="1" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="433">
				  <input name="prod_noshow" type="text"  value="<? echo @$prod_noshow; ?>" size="20" maxlength="50" readonly="" class="style_readonly"><input name="FG" type="button" id="FG"  onClick="lovBOM('1,2');"  value="�Թ���(BOM)">
