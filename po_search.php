								...
								<tr>
									...
									<td>
										...
										<?php if($roles_user=='MS'){  ?>
											<option value="1" <?php if((@$s_po_status=="")||(@$s_po_status=="1")) echo "selected"; ?>>MS สร้างใบ PO ในระบบ</option>
										<?php } ?>
											<option value="2" <?php if(@$s_po_status=="2") echo "selected"; ?>>MS พิมพ์ใบ PO เรียบร้อยแล้ว</option>
											<option value="3" <?php if(@$s_po_status=="3") echo "selected"; ?>>MS Clear ใบ PO</option>
											<option value="4" <?php if(@$s_po_status=="4") echo "selected"; ?>>โกดังทำรับเข้าแล้ว</option>
											<option value="5" <?php if(@$s_po_status=="5") echo "selected"; ?>>PO ถูกยกเลิกโดย MS</option>
											<option value="all" <?php if(@$s_po_status=="all") echo "selected"; ?>>ทุกสถานะ</option>
										</select>
									</td>
								</tr>
								<tr>
								...
								<?php 
									switch($choice_value){
										case 'poup'		: ?><td class="tdcenterblack" width="25">Edit</td>
																		<td class="tdcenterblack" width="60">เลื่อนวันส่ง</td><?php			break;
								...
								?>
									...
									<?php
										switch($choice_value){
											case 'poup'		:	?><td>
																<div align="center">	
															<a href="./pomas_edit.php?po_no=<?php echo $po_no; ?>&flag=edit"  title="ดูรายละเอียด">
																		<img src="../include/images/edit_icon.png" border="0"></a>
																</div>
															</td>	
															<td>
															<div align="center">	
															<a href="./po_search_Delivery.php?po_no=<?php echo $po_no; ?>"  title="เลื่อนวันส่ง">
