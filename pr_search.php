...
<?				
				if(($choice_value == 'prup')||($choice_value == 'prdel')){
?>				
						<input name="s_status" type="radio" value="1" <? if((@$s_status=="1")||(@$s_status=="")||(@$s_status=="2")||(@$s_status=="4")||(@$s_status=="5")||(@$s_status=="6")) echo "checked"; ?>>ผู้แทนพิมพ์ใบขอซื้อ(ยังไม่ส่ง)
						<input name="s_status" type="radio" value="3" <? if(@$s_status=="3") echo "checked"; ?>>ผู้จัดการไม่อนุมัติใบขอซื้อ รอแก้ไข
						<input name="s_status" type="radio" value="7" <? if(@$s_status=="7") echo "checked"; ?>>MS ตีกลับใบขอซื้อ
						<input name="s_status" type="radio" value="all" <? if(@$s_status=="all") echo "checked"; ?>>ทั้งหมด
<?
				}else if($choice_value == 'prcom'){
?>
						<input name="s_status" type="radio" value="1" <? if((@$s_status=="1")||(@$s_status=="")) echo "checked"; ?>>ผู้แทนพิมพ์ใบขอซื้อ(ยังไม่ส่ง)
						<input name="s_status" type="radio" value="2" <? if(@$s_status=="2") echo "checked"; ?>>รออนุมัติจากผู้จัดการ
						<input name="s_status" type="radio" value="3" <? if(@$s_status=="3") echo "checked"; ?>>ผู้จัดการไม่อนุมัติใบขอซื้อ รอแก้ไข<br>
						<input name="s_status" type="radio" value="4" <? if(@$s_status=="4") echo "checked"; ?>>รอ MS ออก PO 
						<input name="s_status" type="radio" value="5" <? if(@$s_status=="5") echo "checked"; ?>>MS ออก PO เรียบร้อยแล้ว 
						<input name="s_status" type="radio" value="6" <? if(@$s_status=="6") echo "checked"; ?>>รับสินค้าได้แล้ว<br>
						<input name="s_status" type="radio" value="7" <? if(@$s_status=="7") echo "checked"; ?>>MS ตีกลับใบขอซื้อ
						<input name="s_status" type="radio" value="all" <? if(@$s_status=="all") echo "checked"; ?>>ทั้งหมด
<?
				}else if($choice_value == 'prapp'){
?>
						<input name="s_status" type="radio" value="2" <? if((@$s_status=="2")||(@$s_status=="")||(@$s_status=="1")) echo "checked"; ?>>รออนุมัติจากผู้จัดการ
						<input name="s_status" type="radio" value="3" <? if(@$s_status=="3") echo "checked"; ?>>ผู้จัดการไม่อนุมัติใบขอซื้อ รอแก้ไข<br>
						<input name="s_status" type="radio" value="4" <? if(@$s_status=="4") echo "checked"; ?>>รอ MS ออก PO 
						<input name="s_status" type="radio" value="5" <? if(@$s_status=="5") echo "checked"; ?>>MS ออก PO เรียบร้อยแล้ว 
						<input name="s_status" type="radio" value="6" <? if(@$s_status=="6") echo "checked"; ?>>รับสินค้าได้แล้ว<br>
...
?>
						<input name="s_status" type="radio" value="4" <? if((@$s_status=="4")||(@$s_status=="")||(@$s_status=="1")||(@$s_status=="2")||(@$s_status=="3")||(@$s_status=="7")) echo "checked"; ?>>รอ MS ออก PO 
						<input name="s_status" type="radio" value="5" <? if(@$s_status=="5") echo "checked"; ?>>MS ออก PO เรียบร้อยแล้ว 
						<input name="s_status" type="radio" value="6" <? if(@$s_status=="6") echo "checked"; ?>>รับสินค้าได้แล้ว
						<input name="s_status" type="radio" value="all" <? if(@$s_status=="all") echo "checked"; ?>>ทั้งหมด
<?				
				}
?>					</td>	
...
?>
			  <tr>
					<td>
						<div align="center">
									<? if($choice_value == 'prup') {	?>
														<a href="./prmas_edit.php?pr_no=<? echo $pr_no; ?>&flag=edit"  title="ดูรายละเอียด">
					...
					<? }else if($choice_value=="prrep"){ ?>
								<td>
										<div align="center">
											<a onClick="remote_addscroll('pr_add_po.php?pr_no=<? echo $pr_no; ?>&flag=open',500,400);"   style="cursor:hand"><font color="red">ระบุ PO <br>ที่สั่งซื้อสินค้าให้</font></a>
										</div>
								</td>
								<? if($pr_status=='4'){ ?>											
										<td>
											<div align="center">
														<a onClick="remote_do('pr_closecode.php?pr_no=<? echo $pr_no; ?>&flag_status=7');"   style="cursor:hand"><font color="red">ตีกลับ<br>
														ใบขอซื้อ</font></a>
											</div>
										</td>														
										<td>
											<div align="center">
														<a onClick="remote_do('pr_closecode.php?pr_no=<? echo $pr_no; ?>&flag_status=5');"   style="cursor:hand"><font color="red">ออก PO <br>เรียบร้อยแล้ว</font></a>
											</div>
										</td>														
								<? }else if($pr_status=='5'){ ?>											
										<td>
										...
										<td>
											<div align="center">
														<a onClick="remote_do('pr_closecode.php?pr_no=<? echo $pr_no; ?>&flag_status=6');"   style="cursor:hand"><font color="red">รับสินค้าได้แล้ว</font></a>
											</div>
										</td>
								<? }else{ ?>		
										<td>&nbsp;</td><td>&nbsp;</td>										
