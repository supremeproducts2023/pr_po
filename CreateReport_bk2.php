...
/*			$strPoMaster = "select to_char(p.po_date,'YYYY-MM-DD') po_date,
						...
						('ตำบล' || s.tambol || ' อำเภอ' ||  s.district || ' จังหวัด' || s.province || ' รหัสไปรษณีย์ ' || s.postcode) supplier_address2,
						('เบอร์โทรศัพท์: ' || s.supplier_address3 || ', ' || s.supplier_address3_1 || ' แฟกซ์ : ' || s.fax_number ) supplier_address3,s.supplier_title,
