...
?>
	...
	<body topmargin="0" leftmargin="0">
		...
		if (@$_POST["flagAction"] == 'AddCode') {
			...
			$str_mx = "select isnull(max(substring(pr_no,5,5))+1,1) int_mx from pr_master ";
			$str_mx = $str_mx . "where substring(pr_no,3,2) = '" . $int_year . "'";
			...
			$strINS = "insert into pr_master (
											...
											'$pr_no',convert(date, '$pr_date',103),'$deptno','$empno','$mngno','$PayCode','$pr_payment',
											'$flag_obj','$obj_name1','$obj_name2','$obj_name3',
											'$estimate_day',$supplier_id,'$pr_remark',
		...
		<center>
			<form name="form_pr" action="prmas_add.php" method="post" enctype="multipart/form-data">
				...
				<table width="870" border="0" cellpadding="0" cellspacing="0" bgcolor="E9EAEB">
					<tr>
						<th> &nbsp;&nbsp;เพิ่ม PR <?php if ($_SESSION["pr_type"] == "T") echo "Transtek";
			...
			-->
											...
											<tr>
												...
												<td><input name="supplier_id" type="text" value="<?php echo @$supplier_id; ?>" size="10" class="style_readonly" readonly="">
													<input name="supplier_show" type="text" value="<?php echo @$supplier_show; ?>" size="70" class="style_readonly" readonly=""><input name="supplier_but" type="button" value="..." onClick="lovSupplier();">
												</td>
											</tr>
											<tr>
										...
										<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
											...
											<tr>
												<td colspan="9" class="tdleftblack">
													<div align="right"><img src="../include/button/add4.gif" name="butadd" width="106" height="24" border="0"></a> </div>
												</td>
											</tr>
										</table>
									</td>
									...
									<td>
										<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
											<tr>
												<th colspan="3">
													<div align="right">
														<a onClick="return check_pr(document.form_pr,'<?= $_SESSION["pr_type"]; ?>');" style="cursor:hand" onMousedown="document.images['butsave'].src=save3.src" onMouseup="document.images['butsave'].src=save1.src" onMouseOver="document.images['butsave'].src=save2.src" onMouseOut="document.images['butsave'].src=save1.src">
															<img src="../include/button/save1.gif" name="butsave" width="106" height="24" border="0"></a>

														<a onClick="document.form_pr.reset();" style="cursor:hand" onMousedown="document.images['butcancel'].src=cancel3.src" onMouseup="document.images['butcancel'].src=cancel1.src" onMouseOver="document.images['butcancel'].src=cancel2.src" onMouseOut="document.images['butcancel'].src=cancel1.src">
