...
?>
				...
				<td>
						<input name="doc_type" type="radio" value="all" <?php if(($roles_user == 'MNGShowPO')or ($roles_user == 'ShowPO2')or ($roles_user=='MNGGWD'))echo "disabled"; else echo "checked"; ?>> PO ที่ระบบ Generate แสดงรายการทั้งหมด <br>
						<input type="radio" name="doc_type" value="nonprice"  <?php if(($roles_user == 'MNGShowPO')or($roles_user == 'ShowPO2')or ($roles_user=='MNGGWD'))echo "checked"; ?>>PO ที่ระบบ Generate ปิดราคา <br>									
						<input type="radio" name="doc_type" value="nontail" <?php if(($roles_user == 'MNGShowPO')or($roles_user == 'ShowPO2')or ($roles_user=='MNGGWD'))echo "disabled"; ?>> PO ที่ระบบ Generate ปิดท้าย </td>
				</tr>	
<?php
